...
public class EnjutoMojamuTeamEnsayoAlex2 extends ControlSystemSS
{
	  ...
	  // Dimensiones del campo y de las porterï¿½as (Del equipo PROFES1, comprobar, porque alguno utiliza otros valores porque tal vez interese)
	  static final double ANCHO_CAMPO = 1.525;
	  static final double LONGITUD_CAMPO = 2.74;
	  static final double ANCHO_PORTERIA = 0.45; //En teorï¿½a 0.5, peor tal vez nos interese esta distancia.
...
// Antes:
		...
		if ( /*estasEnBanda() ||*/ lejosDeTuArea() /*|| !estasBajoPalosEnY()*/ ) {
			...
			//System.out.println("PORTERO: balonCercaAreaPropia y balï¿½n avanzando centrado");
			abstract_robot.setSpeed(curr_time, 0);
			abstract_robot.setSteerHeading(curr_time, balon.t);
			...
			//System.out.println("PORTERO: balonCercaAreaPropia y balï¿½n avanzando escorado banda arriba");
			if (estadoPortero!=3)
				abstract_robot.setSpeed(curr_time, 0);
			abstract_robot.setSteerHeading(curr_time, ourLeftPost.t);
			...
			//System.out.println("PORTERO: balonCercaAreaPropia y balï¿½n avanzando escorado banda abajo");
			if (estadoPortero!=4)
				abstract_robot.setSpeed(curr_time, 0);
			abstract_robot.setSteerHeading(curr_time, ourRightPost.t);
			abstract_robot.setSpeed(curr_time, 0.7); //Antes 0.5
		...
		//ANTES:
			...
			//System.out.println("PORTERO: Estï¿½s bajo palos pero no en el centro vertical del campo");
			...
			//System.out.println("PORTERO: !balonCercaAreaPropia y sï¿½ balonDemasiadoLejosDeAreaPropia");
			if (estadoPortero!=7)
				abstract_robot.setSpeed(curr_time, 0);
			abstract_robot.setSteerHeading(curr_time, ourGoal.t);
			abstract_robot.setSpeed(curr_time, 1); //Antes 0.5	
		...
		//else if (estasBajoPalos() && estasEnElCentroVerticalDelCampo()) {
		//	//No hace falta seguir moviï¿½ndose hacia la porterï¿½a y se puede tener el steerHeading mirando a la bola.
		//	//System.out.println("PORTERO: Estï¿½s bajo palos y en el centro vertical del campo");
		//	abstract_robot.setSpeed(curr_time, 0);
		//	abstract_robot.setSteerHeading(curr_time, balon.t);
		//}
		...
		/*else if (estasBajoPalos() && balonDemasiadoLejosDeAreaPropia() && maxCiclosSeguirY>0) {
			maxCiclosSeguirY--;
			//No hace falta seguir moviï¿½ndose hacia la porterï¿½a y se puede tener el steerHeading mirando a la bola.
			//System.out.println("PORTERO: Estï¿½s bajo palos y el balon demasiado lejos del area propia. Sigues la y de la bola como maximo " + maxCiclosSeguirY +" ciclos mï¿½s.");
			abstract_robot.setSpeed(curr_time, 0);
			...
			//No hace falta seguir moviï¿½ndose hacia la porterï¿½a y se puede tener el steerHeading mirando a la bola.
			//System.out.println("PORTERO: Estï¿½s bajo palos y el balon demasiado lejos del area propia. Sigues la y de la bola como maximo unos ciclos mï¿½s.");
			abstract_robot.setSpeed(curr_time, 0);
			abstract_robot.setSteerHeading(curr_time, ourGoal.t);
			abstract_robot.setSpeed(curr_time, 1);
			//maximoSeguirYBola;
			...
			//System.out.println("PORTERO: Estï¿½s bajo palos en X pero no en y.");
			abstract_robot.setSpeed(curr_time, 0);
			abstract_robot.setSteerHeading(curr_time, ourGoal.t);
			abstract_robot.setSpeed(curr_time, 1);
		}
		//Prueba
			...
			//System.out.println("PORTERO: default: ir a tu porterï¿½a...");
			abstract_robot.setSpeed(curr_time, 0);
			// set heading towards it
			abstract_robot.setSteerHeading(curr_time, ourGoal.t);
			// set speed at maximum
			...
			//No hace falta seguir moviï¿½ndose hacia la porterï¿½a y se puede tener el steerHeading mirando a la bola.
/*
			//System.out.println("PORTERO: Por defecto, estï¿½s parado.");
			////System.out.println("PORTERO: Por defecto, estï¿½s bajo palos y sigues la y de la bola.");
			abstract_robot.setSpeed(curr_time, 0);
			//Importante: Para saber si estï¿½ escorado o no se utiliza ballMenosOurGoal, pero para seguir la direcciï¿½n de la y se utiliza ball.y.
//			Vec2 nuevaDireccion= new Vec2(0,balon.y);
		...
		if (estadoPorteroAnterior!=estadoPortero) {
			//System.out.println("******* TRANSICIï¿½N *******");
		}
