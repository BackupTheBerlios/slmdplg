...
public class TBSim extends Frame 
    ...
    private static final String kickOffCommandName = "kickoff";
	...
	public TBSim(String file, int width, int height, 
        ...
        Button kickoff_button = new Button(kickOffCommandName);
        kickoff_button.addActionListener(this);
        button_area.add(kickoff_button);
		...
		System.out.println("SoccerBots: WindowCreated");
	...
	public void actionPerformed(ActionEvent e)
		...
		if (command==quitCommandName)
			{
			simulation.quit("isbc:requestEnd");
			//System.exit(0);
			}
